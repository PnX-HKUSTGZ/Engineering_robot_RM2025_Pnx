...
void RedeemBox_detector::DetectArrowInit(){    
    RCLCPP_INFO(this->get_logger(),"ArrowDetectorInit completed successfully with parameters:");
    RCLCPP_INFO(this->get_logger(),"  PixelNum: %d-%d", ArrowDetectorPixelNumMin, ArrowDetectorPixelNumMax);
    RCLCPP_INFO(this->get_logger(),"  CannyThreshold: %.1f-%.1f", ArrowDetectorCannyThreshold1, ArrowDetectorCannyThreshold2);
    RCLCPP_INFO(this->get_logger(),"  LengthWidthRatio: %.2f-%.2f", ArrowDetectorLengthWidthRatioMin, ArrowDetectorLengthWidthRatioMax);
}
